  ...
  function PositionStats($http, $q){
    ...
    function getQbGames() {
      ...
      if (instance.QB.length) {
        ...
        $http.get('sports-stats-pro.herokuapp.com/games/qbs')
        .then(function(res) {
    ...
    function getRbGames() {
      ...
      if (instance.RB.length) {
        ...
        $http.get('sports-stats-pro.herokuapp.com/games/rbs')
        .then(function(res) {
    ...
    function getWrGames() {
      ...
      if (instance.WR.length) {
        ...
        $http.get('sports-stats-pro.herokuapp.com/games/wrs')
        .then(function(res) {
    ...
    function getTeGames() {
      ...
      if (instance.TE.length) {
        ...
        $http.get('sports-stats-pro.herokuapp.com/games/tes')
        .then(function(res) {
